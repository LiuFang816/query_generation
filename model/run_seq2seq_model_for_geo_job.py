# -*- coding: utf-8 -*-
from data_reader_for_geo_job import *
from seq2seq import *
import time
import nltk
...
flags.DEFINE_string('save_path','../data/checkpoints/seq2seq/geo/best_validation','best val save path')
flags.DEFINE_string('save_dir','../data/checkpoints/seq2seq/geo','save dir')
flags.DEFINE_string('tensorboard_dir','../data/tensorboard/seq2seq/geo','tensorboard path')
flags=flags.FLAGS
